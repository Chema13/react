          ...
          <div className='flex items-center'>
            ...
            <div>
              <form>
                ...
                <button
                  type='submit'
                  className='material-symbols-outlined text-white absolute py-[8px] translate-x-[-40px]
                                '
                >
                  search
                </button>
            ...
            <div>
              <div
                className='bg-[#262a2e] flex items-center px-2 py-2 rounded-md hover:bg-[#22262a] 
                            transition-colors delay-75 hover:cursor-pointer'
              >
                <label
                  htmlFor='inicioSesion'
                  className='material-symbols-outlined text-white text-lg font-extrabold'
                >
                  person
                </label>
                <span
                  id='inicioSesion'
                  className='uppercase text-white font-bold text-sm'
                >
                  login
                </span>
              </div>
